...
<nav class="navbar navbar-light bg-light">
	<div class="container-fluid">
		...
		<form class="form-inline">
			<button type="button" class="btn btn-outline-primary" style="margin: 0px 15px 0px 0px;" data-toggle="modal" data-target="#signup_modal">Sign Up</button>
			<button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#login_modal">Log In</button>
		</form>
	</div>
</nav>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body row">
				...
				<button class="btn col-sm-4 signup-close" onclick="sendData('company', 'register')">Company</button>
				<div class="col-sm-2"></div>
				<button class="btn col-sm-4 signup-close" onclick="sendData('trader', 'register')">Trader</button>
				<div class="col-sm-1"></div>
			</div>
		</div>
	</div>
